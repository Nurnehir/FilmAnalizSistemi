const tr = {
  ...
  // Shared lists
  social_shared_lists: 'Ortak Listeler',
  social_new_shared: 'Yeni Ortak Liste',
  social_new_shared_subtitle: 'Bir isim verin, sonra arkadaşları davet edin.',
  social_new_shared_placeholder: 'Liste adı...',
  social_invite: 'Davet Et',
  social_invite_placeholder: 'Kullanıcı adı ile ara...',
  social_invite_btn: 'Davet Gönder',
  social_leave: 'Listeden Ayrıl',
  social_leave_confirm: '"{name}" listesinden ayrılmak istediğinize emin misiniz?',
  social_leave_confirm_owner: 'Bu listenin sahibisiniz. Ayrılırsanız liste ve tüm içeriği silinir.',
  social_added_by: 'Ekleyen:',
  social_add_film: 'Film Ekle',
  social_add_film_placeholder: 'Film ara...',
  social_no_shared_lists: 'Henüz ortak listeniz yok.',
  social_no_shared_lists_sub: 'Yeni liste oluşturun ve arkadaşlarınızı davet edin.',
  social_shared_empty: 'Bu listede henüz film yok.',
  social_members: 'Üyeler',
  social_owner_badge: 'Sahibi',
  shared_film_added: 'Film listeye eklendi.',
  shared_film_exists: 'Bu film zaten listede.',
  shared_remove_confirm: 'Bu filmi listeden kaldırmak istiyor musunuz?',
