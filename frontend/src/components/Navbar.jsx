        ...
        <div className="flex items-center justify-between h-16">
          ...
          {searchOpen ? (
            <div className="flex items-center w-full gap-3">
              ...
              <button
                onClick={closeSearch}
                className="w-9 h-9 flex-shrink-0 flex items-center justify-center rounded-lg text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
              >
